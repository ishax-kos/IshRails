...
public interface IAbstractIshRailBlock {
     ...
     */
    IshRailShape getRailDirection(BlockState state, IBlockReader world, BlockPos pos, @Nullable AbstractMinecartEntity cart);
